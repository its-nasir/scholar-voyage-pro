...
export function EnquiryForm({ source = "quick-enquiry" }: { source?: string }) {
  ...
  return (
    ...
    >
      ...
      <FieldShell label="Preferred Course" htmlFor="eq-course" required error={errors.course}>
        <input id="eq-course" className={inputClass} placeholder="e.g. MSc Data Science" {...register("course")} />
      </FieldShell>

      <FieldShell label="Highest Qualification" htmlFor="eq-qual" required error={errors.qualification}>
        <input id="eq-qual" className={inputClass} placeholder="e.g. B.Tech, B.Com, 12th" {...register("qualification")} />
      </FieldShell>

      <FieldShell label="Academic Percentage / CGPA" htmlFor="eq-score" required error={errors.academicScore}>
        <input id="eq-score" className={inputClass} placeholder="e.g. 72% or 7.4 CGPA" {...register("academicScore")} />
      </FieldShell>

      <FieldShell label="Intake" htmlFor="eq-intake" required error={errors.intake}>
